...
.container {
  ...
  /* Centralizando verticalmente com Flexbox */
  margin: auto;
  position: absolute;
  top: 0;
  bottom: 0;
...
.form-group {
  margin-bottom: 20px;
  margin-bottom: 10px;
  /* Adicionado para adicionar espaçamento entre os campos */
}

a {
  text-decoration: underline;
  color: blue;
  /* Adicionado para estilo do link */
}
...
.error {
  ...
  /* Adicionado para estilo do erro */
  padding: 10px;
}
