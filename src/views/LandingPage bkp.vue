...
#color-setup {
  --orange: #ff7f50;
  /* Um tom de laranja mais suave */
  --dark-orange: #ff6f00;
  /* Mantém o laranja escuro */
  --yellow: #ffd700;
  /* Amarelo ouro mais suave */
  --purple: #7b68ee;
  /* Tom de roxo mais suave */
  --dark-purple: #5c3c8a;
  /* Mantém o roxo escuro */
  --white: #ffffff;
  --light-gray: #f7f7f7;
  /* Cinza claro mais suave */
  --dark-gray: #333333;
  --text-gray: #666666;
  /* Cinza de texto para suavizar */
}
