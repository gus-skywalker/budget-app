    ...
    <v-list-item>
        <v-row align="center">
            ...
            <v-col class="d-flex justify-end">
                ...
                <v-btn x-small icon height="35px" width="35px" @click="handleToggleRecurring" color="primary"
                    class="mr-2">
        ...
        <v-dialog v-model="recurrenceDialog" persistent max-width="400px">
            <v-card>
                ...
                <v-card-text>
                    <v-select v-model="selectedMonths" :items="monthsOptions" label="Quantidade de meses"
                        dense></v-select>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
